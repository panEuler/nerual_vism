...
class MoleculeDataset(Dataset):
    ...
    def _discover_records(self) -> list[MoleculeRecord]:
        ...
        if split_file.exists():
            ...
            materialized_split_root = self.root.parent / self.split
            if materialized_split_root.is_dir():
                sample_dirs = [materialized_split_root / sample_id for sample_id in sample_ids]
            else:
